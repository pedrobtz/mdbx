...
- [Getting started](https://pedrobtz.github.io/mdbx/articles/mdbx.html)
  — a longer tour of the same ground, plus batching, bulk loads and the
  patterns that matter in practice.
- [Designing a disk
  cache](https://pedrobtz.github.io/mdbx/articles/cache.html) — how the
  SQLite-shaped parts of a cache map onto ordered keys and named
  databases.
